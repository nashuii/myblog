# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-11-20 15:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='DiscussToDiscussModel',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content', models.TextField()),
                ('auth', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('discuss', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='article.DiscussModel')),
            ],
        ),
    ]
